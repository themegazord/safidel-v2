...
namespace App\Livewire\Icons\Itens;

use Livewire\Component;

class MiniPizza extends Component
{
  public function render()
  {
    return <<<'HTML'
                      <svg class="m-auto mb-4" height="50px" width="50px" version="1.1" id="_x35_"
