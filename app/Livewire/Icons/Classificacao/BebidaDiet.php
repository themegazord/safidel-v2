...
class BebidaDiet extends Component
{
  ...
  {
    return <<<'HTML'
          <svg class="{{ $this->estilo }}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="{{ $this->width }}" height="{{ $this->height }}" viewBox="0 0 164.681 164.681"
            xml:space="preserve">
          <g>
            <path class="{{ $this->estilo }}" d="M140.635,17.105c-6.674-3.666-14.31-5.776-22.463-5.776c-14.413,0-27.292,6.555-35.823,16.831
