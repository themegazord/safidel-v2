...
class BebidaNatural extends Component
{
  ...
  {
    return <<<'HTML'
          <svg class="{{ $this->estilo }}"  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="{{ $this->width }}" height="{{ $this->height }}" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
          <g>
            <path class="{{ $this->estilo }}"  d="M57.473,42.533c0-5.891-6.195-18.732-12.889-31.731c-0.48-0.937-0.902-1.752-1.242-2.422
            ...
            <path class="{{ $this->estilo }}"  d="M36.381,21.469c-0.553,0-1,0.447-1,1v1c0,0.553,0.447,1,1,1s1-0.447,1-1v-1C37.381,21.916,36.934,21.469,36.381,21.469z"/>
            <path class="{{ $this->estilo }}"  d="M26.749,36.019c-0.19,0.19-0.3,0.45-0.3,0.709c0,0.271,0.11,0.53,0.29,0.711c0.19,0.189,0.45,0.289,0.71,0.289
